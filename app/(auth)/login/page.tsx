...
import { Briefcase, Mail, Lock, Eye, EyeOff, Upload, Phone, History } from "lucide-react";
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-slate-400 mt-3 text-sm leading-relaxed">
              Your smart job-application assistant — from screenshot to sent email in seconds.
            </p>
          </div>
      ...
      <div className="flex-1 flex items-center justify-center bg-slate-50 px-4 py-10">
        <div className="w-full max-w-md">
          ...
          <div className="hidden md:block mb-8">
            ...
            <p className="text-slate-500 mt-1 text-sm">Sign in to continue your job search.</p>
          </div>
